...
public class Venda {
    ...
    public void efetuarDesconto(double desconto) {
        ...
        if ((this.produto.getValorVenda() - this.desconto) < produto.getValorCusto()) {
            ...
            System.out.println("O valor final do produto será: R$" + produto.getValorVenda());
        }
    }
    ...
    public void calcularComissao() {
        if (this.produto.getPromocao() == true) {
            vendedor.setComissao((valor * (vendedor.comissao/100)) / 2);
        } else {
            vendedor.setComissao(valor * (vendedor.getComissao() / 100));
        }
    }
    ...
    public void imprimir(){
        ...
        System.out.println("Produto com promoção: " + produto.getPromocao());
